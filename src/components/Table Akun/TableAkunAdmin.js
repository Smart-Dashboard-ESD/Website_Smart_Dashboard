...
export default function TableAkunAdmin() {
  const data = [
    {
  ...
  return (
    <div className="default:w-[1110px] default:ml-[15px] default:mt-[30px] default:h-[515px] bg-white rounded">
      <div className="flex default:pt-[26px] item-center default:ml-[29px]">
        ...
        <select className="default:w-[223px] appearance-none default:ml-[289px] default:h-[48px] px-3 rounded-md border border-Info-NormalActive text-Info-NormalActive">
        ...
        <HiChevronDown className="absolute default:top-[155px] default:right-[420px] text-Info-NormalActive" />
        <input
          placeholder="Cari"
